...
class AssessorSupportController extends Controller
{
    ...
    public function insertRegisterComplain(Request $request){
        ...
        alert()->success("Your Complain has been <span style='color:blue;font-weight:bold'>Submitted </span>and  Your Token ID is : <span style='color:blue;font-weight:bold'>".$new_tokenid." </span>", 'Job Done')->html()->autoclose(4000);
    ...
    public function myComplain(){
        $complain=Complain::where([['rel_with','=','assessor'],['rel_id','=',$this->guard()->user()->id]])->get();
