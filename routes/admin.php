...
Route::get('mis/old_mis', 'AdminAuth\AdminMisController@oldMis')->name('mis.old_mis_view');
Route::get('mis/old_documents', 'AdminAuth\AdminMisController@oldDocument')->name('mis.old-document-block');
Route::get('mis/old_documents/{data}', 'AdminAuth\AdminMisController@oldDocumentPart')->name('mis.old-document-part');
Route::get('mis/old_document_download/{folder}/{document}', 'AdminAuth\FileController@oldDocumentDownload')->name('mis.old-document-download');
...
Route::post('tot-toa/toa-batches/add', 'AdminAuth\TotToaController@submitToaBatches')->name('tot-toa.toa-batches.submit');//
Route::get('tot-toa/tot-batches/marks/{id}', 'AdminAuth\TotToaController@addTotMarks')->name('tot-toa.tot-batches.marks.add');//
Route::get('tot-toa/toa-batches/marks/{id}', 'AdminAuth\TotToaController@addToaMarks')->name('tot-toa.toa-batches.marks.add');
...
Route::post('tot-toa/toa-batches/marks/submit', 'AdminAuth\TotToaController@submitToaMarks')->name('tot-toa.toa-batches.marks.submit');
Route::get('tot-toa/tot-batches/view/{id}', 'AdminAuth\TotToaController@viewTotBatch')->name('tot-toa.tot-batches.view');//
Route::get('tot-toa/toa-batches/view/{id}', 'AdminAuth\TotToaController@viewToaBatch')->name('tot-toa.toa-batches.view');//
...
Route::post('tot-toa/assessors/linking', 'AdminAuth\TotToaController@submitLinkingAssessor')->name('tot-toa.assessors.linking.submit');
...
Route::get('tot-toa/assessors/{id}', 'AdminAuth\TotToaController@viewAssessor')->name('tot-toa.assessor.view');
...
Route::post('tot-toa/add-tot/api', 'AdminAuth\TotToaController@redundantCheckApi')->name('tot-toa.redundant.api');
Route::post('tot-toa/add-tot/batches/api', 'AdminAuth\TotToaController@totBatchApi')->name('tot.batch.api');
Route::post('tot-toa/add-toa/batches/api', 'AdminAuth\TotToaController@toaBatchApi')->name('toa.batch.api');
Route::get('tot-toa/add-toa', 'AdminAuth\TotToaController@addAssessorCert')->name('tot-toa.addassessorcert');
Route::post('tot-toa/add-toa', 'AdminAuth\TotToaController@submitAddAssessorCert')->name('tot-toa.addassessorcert.submit');
/** End TOT-TOA Section */
...
Route::post('batches/batches', 'AdminAuth\AdminBatchController@batchUpdateDates')->name('batch.batches.up');
...
Route::post('support/stage-close', 'AdminAuth\AdminSupportController@stageClose')->name('support.stage-close');
