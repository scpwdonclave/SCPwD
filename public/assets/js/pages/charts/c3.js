    ...
    $(document).ready(function(){
        var chart = c3.generate({
            ...
            data: {
                ...
                colors: {
                    'data1': square.colors["orange"],
                    'data2': square.colors["blue"],
                    'data3': square.colors["green"]
                },
                names: {
                    // name of each serie
                    'data1': 'Development',
    ...
    $(document).ready(function(){
        var chart = c3.generate({
            ...
            data: {
                ...
                type: 'line', // default type of chart
                colors: {
                    'data1': square.colors["blue"],
                    'data2': square.colors["green"]
                },
                names: {
                    // name of each serie
                    'data1': 'Tokyo',
    ...
    $(document).ready(function(){
        var chart = c3.generate({
            ...
            data: {
                ...
                colors: {
                    'data1': square.colors["blue-darker"],
                    'data2': square.colors["blue"],
                    'data3': square.colors["blue-light"],
                    'data4': square.colors["blue-lighter"]
                },
                names: {
                    // name of each serie
                    'data1': 'A',
    ...
    $(document).ready(function(){
        var chart = c3.generate({
            ...
            data: {
                ...
                colors: {
                    'data1': square.colors["green"],
                    'data2': square.colors["green-light"]
                },
                names: {
                    // name of each serie
                    'data1': 'Maximum',
