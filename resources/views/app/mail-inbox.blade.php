            ...
            <ul class="mail_list list-group list-unstyled">
                ...
                <li class="list-group-item unread">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-heading">
                                <a href="{{route('app.mail-single')}}" class="m-r-10">Simply dummy text</a>
                ...
                <li class="list-group-item">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-heading">
                                <a href="{{route('app.mail-single')}}" class="m-r-10">Generators on the Internet</a>
                ...
                <li class="list-group-item">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-heading">
                                <a href="{{route('app.mail-single')}}" class="m-r-10">Contrary to popular</a>
                                <span class="badge bg-blush">Themeforest</span>
                                <small class="float-right text-muted"><time class="hidden-sm-down" datetime="2017">12:35 AM</time><i class="zmdi zmdi-attachment-alt"></i> </small>
                            </div>
