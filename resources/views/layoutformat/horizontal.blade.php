...
<div class="container-fluid">
                ...
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-4 text-center m-b-10">                               
                            <h3 class="counter m-b-0 col-white">$4,516</h3>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 text-center m-b-10">
                            <h3 class="counter m-b-0 col-white">$3,915</h3>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 text-center m-b-10">
                            <h3 class="counter m-b-0 col-white">$6,481</h3>
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-12 col-lg-8">
            <div class="card">
                <div class="header">
                    <h2><strong>Social</strong> Media <small>Description text here...</small></h2>                        
                </div>
                <div class="body">
            ...
            <div class="card agent">
                ...
                <div class="agent-content">
                    ...
                    <ul class="social-icons">
                        ...
                        <li><a class="twitter" href="javascript:void(0);"><i class="zmdi zmdi-twitter"></i></a></li>
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="body">
                    <p class="m-b-0">© 2017 sQuare Admin by <a href="https://thememakker.com/" target="black">ThemeMakker</a> </p>
                </div>
            </div>
        </div>
    </div>
