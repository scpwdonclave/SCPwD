...
@section('content')
  <div class="wrap-login100 p-l-40 p-r-40 p-t-45 p-b-20">
    <form method="POST" id="form_reset_request" action="{{ route('assessor.password.email') }}" class="login100-form">
      @csrf  
      <span class="login100-form-title p-b-10"> <img src="{{ asset('assets/images/scpwd-logo.png') }}" alt="" srcset="" /> </span>
      <span class="login100-form-title m-b-10">Assessor Password Reset</span>      
      ...
      @endif
        ...
        <div class="text-center p-t-30 p-b-20">
          <a href="{{ route('assessor.login') }}" class="txt2 hov1"> Login Here </a>
        </div>
