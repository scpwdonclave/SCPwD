        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="header d-flex justify-content-between">
                    <h2><strong>All</strong> Re-Assessment Results 1</h2>
                </div>
                <div class="body">
                        ...
                        <table class="table nobtn table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                @foreach ($reassessments as $reassessment) 
                                    ...
                                    <td><a class="badge bg-green margin-0" href="{{route('assessor.reassessment.view',Crypt::encrypt($reassessment->batchreassessment->bt_reassid))}}" >View</a></td>
                                @endforeach
                            </tbody>
                        </table>
                    </div>
