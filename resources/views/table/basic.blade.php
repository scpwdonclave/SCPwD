                        ...
                        <table class="table table-hover m-b-0 c_list">
                            <thead>
                                <tr>
                                    <th style="width: 50px;">
                                        <div class="checkbox mb-0">
                                            <input class="select-all" type="checkbox" name="checkbox" id="checkbox7">
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="checkbox mb-0">
                                            <input class="select-all" type="checkbox" name="checkbox" id="checkbox8">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" title="Edit"><i class="zmdi zmdi-edit"></i></button>
                                        <button type="button" data-type="confirm" class="btn btn-danger js-sweetalert btn-sm" title="Delete"><i class="zmdi zmdi-delete"></i></button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="checkbox mb-0">
                                            <input class="select-all" type="checkbox" name="checkbox" id="checkbox9">
                                ...
                                <tr>
                                    <td>
                                        <div class="checkbox mb-0">
                                            <input class="select-all" type="checkbox" name="checkbox" id="checkbox10">
                                ...
                                <tr>
                                    <td>
                                        <div class="checkbox mb-0">
                                            <input class="select-all" type="checkbox" name="checkbox" id="checkbox11">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover m-b-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <i class="zmdi-hc-2x zmdi zmdi-facebook"></i>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class="text-success">
                                            23 <i class="zmdi zmdi-long-arrow-up"></i>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <i class="zmdi-hc-2x zmdi zmdi-twitter"></i>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class="text-danger">
                                            -9 <i class="zmdi zmdi-long-arrow-down"></i>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <i class="zmdi-hc-2x zmdi zmdi-instagram"></i>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class=" text-success">
                                            16 <i class="zmdi zmdi-long-arrow-up"></i>
                                        </div>
                                        <div class="text-muted">up</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <i class="zmdi-hc-2x zmdi zmdi-linkedin"></i>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class=" text-success">
                                            27 <i class="zmdi zmdi-long-arrow-up"></i>
                                        </div>
                                        <div class="text-muted">up</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <i class="zmdi-hc-2x zmdi zmdi-google-plus"></i>
                                    </td>
                                    <td>
                        ...
                        <table class="table table-hover m-b-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 150px;" class="d-xs-none">
                                ...
                                <tr>
                                    ...
                                    <td class="d-xs-none"><div class="progress progress-xs">
                    ...
                    <div class="table-responsive">
                        <table class="table center-aligned-table">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-danger btn-sm"><i class="zmdi zmdi-delete"></i></button></td>
                            </tr>
                            <tr>
                                <td>Q02</td>
                                <td>Galaxy S8</td>
