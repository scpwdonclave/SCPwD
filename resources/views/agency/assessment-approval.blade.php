            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header d-flex justify-content-between">
                        <h2><strong>All</strong> pending Assessment for Approval </h2>
                        ...
                        <div class="table-responsive">
                            <table class="table nobtn table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    @if(!is_null($item->batch->batchassessment) && ($item->batch->batchassessment->aa_verified==0 || $item->batch->batchassessment->aa_verified==2))
                                    <tr>
                                    <td>{{$key+1}}</td>
