                            ...
                            <table id="example" class="table nobtn table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{$aa_batch->batch->batchassessment->candidateMarks->count()}}
                                            <input type="hidden" name="t_can[]" value="{{$aa_batch->batch->batchassessment->candidateMarks->count()}}">
                                        ...
                                        @else
                                        <td>{{$aa_batch->batch->batchassessment->candidateMarks->where('attendence','=','present')->count()}}
                                            <input type="hidden" name="t_can[]" value="{{$aa_batch->batch->batchassessment->candidateMarks->where('attendence','=','present')->count()}}">
                                        ...
                                        <td>{{$aa_batch->reassessment->batchreassessment->candidateMarks->count()}}
                                            <input type="hidden" name="t_can[]" value="{{$aa_batch->reassessment->batchreassessment->candidateMarks->count()}}">
                                        </td>
                                        <td>{{$aa_batch->reassessment->batchreassessment->candidateMarks->count()*500}}</td>
                                        <td style="color:blue">Count Made on Assigned</td>
                                        @else
                                        <td>{{$aa_batch->reassessment->batchreassessment->candidateMarks->where('attendence','=','present')->count()}}
                                            <input type="hidden" name="t_can[]" value="{{$aa_batch->reassessment->batchreassessment->candidateMarks->where('attendence','=','present')->count()}}">
                                        ...
                                        @endif   
                                        {{-- <td>
                                            {{$aa_batch->reassessment->candidates->count()}}
                                            <input type="hidden" name="t_can[]" value="{{$aa_batch->reassessment->candidates->count()}}">
                                        </td>
