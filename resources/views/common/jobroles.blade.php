                                    ...
                                    @if (Request::segment(1) === 'partner')
                                        @foreach ($jobroles as $jobrole)
                                            <tr>
                                                ...
                                                <td class="text-{{($jobrole->status)?'success':'danger'}}"><strong>{{($jobrole->status)?'Active':'Inactive'}}</strong></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-{{($jobrole->partnerjobrole->status)?'success':'danger'}}"><strong>{{($jobrole->partnerjobrole->status)?'Active':'Inactive'}}</strong></td>
                                            </tr>
                                        @endforeach
                                    @endif
                                @endauth
