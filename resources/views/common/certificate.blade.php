        ...
        @if($flag)
            ...
            <div style="height:1000px;width:1500px;position:relative">
                ...
                {{-- <div style="position:absolute;left:138px;top:160px;height:100px;">     --}}
                    {{-- <img src="{{asset('storage/'.(isset($assessment)?$batchdata->scheme->logo:$batch->scheme->logo))}}" style="width:180px;"> --}}
                {{-- </div> --}}
                ...
                <div style="position:absolute;left:625px;top:415px" class="cls_005"><span class="cls_005">Certificate</span></div> 
                @endif
                @if ($batchdata->scheme->scheme === 'AYJNISHD-SIPDA')
                ...
                @endif
                    ...
                    <span class="cls_007"> {{isset($assessment)?$batchdata->jobrole->job_role:$batch->jobrole->job_role}}  (QP No.  {{isset($assessment)?$batchdata->jobrole->qp_code:$batch->jobrole->qp_code}}) </span>
                    <span class="cls_006">conforming to National Skill Qualifications Framework - Level </span><span class="cls_007">{{isset($assessment)?$batchdata->jobrole->nsqf_level:$batch->jobrole->nsqf_level}}</span>
                    <span class="cls_006">through</span>
                    <span class="cls_007"> {{isset($assessment)?$batchdata->center->center_name:$batch->center->center_name}}, {{isset($assessment)?$batchdata->center->city:$batch->center->city}} </span>
