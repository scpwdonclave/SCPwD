                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @if (!is_null($batchReAssessment->attendence_sheet))
                                                <p>
                                                    Attendence Sheet &nbsp;&nbsp;
                                                    <a class="btn-icon-mini" href="{{route('files.assessment-file',['id'=>$batchReAssessment->id,'action'=>'download','column'=>'attendence_sheet','type'=>'1'])}}" ><i class="zmdi zmdi-download"></i></a>                                                    
                                                </p>
                                            @else
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @if (!is_null($batchReAssessment->mark_sheet))
                                                <p>
                                                    Marks Sheet &nbsp;&nbsp;
                                                    <a class="btn-icon-mini" href="{{route('files.assessment-file',['id'=>$batchReAssessment->id,'action'=>'download','column'=>'mark_sheet','type'=>'1'])}}" ><i class="zmdi zmdi-download"></i></a>                                                    
                                                </p>
                                            @else
