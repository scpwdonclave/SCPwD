                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <td>{{$item->spoc_name}}</td>
                                ...
                                <td class="text-center">
                                    {{-- @if ($item->status==1 && $item->complete_profile==1 && $item->pending_verify==0)
                                        <a class="" href="#largeModal{{$item->id}}" data-toggle="modal" data-target="#largeModal{{$item->id}}">target</a>
                                    @else --}}
                            ...
                            <td><a class="badge bg-red margin-0" href="{{route('admin.training_partner.partner.deactive',['id'=>$item->id])}}" >Deactivate</a></td>
                            @elseif($item->status==1 && $item->complete_profile==1 && $item->pending_verify==1)
                            <td><a class="badge bg-grey margin-0" href="javascript:void(0);" disabled>Target</a></td>
                    ...
                    <div class="body">
                       ...
                       <li>
                            <a href="javascript:void(0);">
                                ...
                                <small><strong>Id: </strong>{{$item->tp_id}}</small><br>
