  ...
  <!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #363f48;font-size: 32px;line-height: 40px;font-family: Montserrat,DejaVu Sans,Verdana,sans-serif;"><strong>Let&#8217;s get started.</strong></h1><p style="Margin-top: 20px;Margin-bottom: 0;">Hi {{$partner->spoc_name}},</p><p style="Margin-top: 20px;Margin-bottom: 20px;">Welcome to Skill Council for Persons with Disability (SCPwD). <br ><br >Your Account information has updated .</p>
      </div>
    </div>
