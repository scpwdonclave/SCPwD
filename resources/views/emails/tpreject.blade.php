  ...
  * {
  ...
  <!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #363f48;font-size: 32px;line-height: 40px;font-family: Montserrat,DejaVu Sans,Verdana,sans-serif;"><strong>Let&#8217;s get started.</strong></h1><p style="Margin-top: 20px;Margin-bottom: 0;">Hi {{$partner->spoc_name}},</p><p style="Margin-top: 20px;Margin-bottom: 20px;">Welcome to Skill Council for Persons with Disability (SCPwD). <br ><br ><span style="color:#074ad1"><strong>Sorry your Application has been rejected.</strong></span><br>Reason: <span style="color:#074ad1"><strong> <i>{{$partner->note}}</i> </strong></span><br ><br >Thank you.</p>
      </div>
    </div>
      ...
      <div class="btn btn--shadow btn--medium" style="Margin-bottom: 20px;text-align: center;">
        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 12px;font-weight: bold;line-height: 22px;padding: 10px 20px 11px 20px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #363f48;font-family: Karla, Calibri, Geneva, sans-serif;" href="{{ url('partner/login') }}">Get Started</a><![endif]>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        {{-- <a style="Margin-top: 0;Margin-bottom: 20px;">Or Follow This Link:&nbsp; <br><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #4c4dc3;" href="{{ url('partner/login') }}">{{ url('partner/login') }}</a></a> --}}
      </div>
    </div>
