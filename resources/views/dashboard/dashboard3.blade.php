...
@section('page-style')
<link rel="stylesheet" href="{{asset('assets/plugins/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.cs')}}s">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card">
                ...
                <div class="list-group list-widget">
                    <a href="{{route('app.mail-inbox')}}" class="list-group-item"> 
                        <span class="badge badge-success">654</span>                           
                        <i class="zmdi zmdi-email text-muted"></i>Inbox                            
                    </a>
                    <a href="javascript:void(0);" class="list-group-item">
                        <span class="badge badge-info">364</span>
                        <i class="zmdi zmdi-eye text-muted"></i> Profile visits</a>
                    <a href="javascript:void(0);" class="list-group-item">
                        <span class="badge badge-warning">12</span>
                        <i class="zmdi zmdi-phone text-muted"></i> Call</a>
                    <a href="javascript:void(0);" class="list-group-item">
                        <span class="badge badge-danger">54</span>
                        <i class="zmdi zmdi-comments text-muted"></i> Messages</a>
                    <a href="javascript:void(0);" class="list-group-item">
                        <span class="badge badge-warning">19</span>
                        <i class="zmdi zmdi-bookmark text-muted"></i> Bookmarks</a>
                    <a href="javascript:void(0);" class="list-group-item">
                        <span class="badge">56</span>
                        <i class="zmdi zmdi-notifications text-muted"></i> Notifications</a>
                    <a href="javascript:void(0);" class="list-group-item">
                        <span class="badge badge-info">25</span>
                        <i class="zmdi zmdi-time text-muted"></i> Watch</a>
                </div>
                </div>
            </div>
        </div>
                            ...
                            <li class="dd-item dd3-item" data-id="1">
                                ...
                                <div class="dd3-content">
                                    <div class="checkbox">
                                        ...
                                        <label for="checkbox"><i class="zmdi zmdi-calendar m-r-5"></i> Report Panel Usag</label>
                                    </div>
                                </div>
                                <ol class="dd-list">
                                    <li class="dd-item dd3-item" data-id="1">
                                        ...
                                        <div class="dd3-content">
                                            <div class="checkbox">
                                                ...
                                                <label for="checkbox7"> Report Panel Usag</label>
                                            </div>
                                        </div>
                                    </li>
                                </ol>
                            ...
                            <li class="dd-item dd3-item" data-id="1">
                                ...
                                <div class="dd3-content">
                                    <div class="checkbox">
                                        ...
                                        <label for="checkbox8"><i class="zmdi zmdi-notifications m-r-5"></i> New logo design for InfiniO</label>
                                    </div>
                                </div>
                            </li>
                            <li class="dd-item dd3-item" data-id="1">
                                ...
                                <div class="dd3-content">
                                    <div class="checkbox">
                                        ...
                                        <label for="checkbox9">Design PSD files for InfiniO <span class="badge badge-warning">1 Week</span></label>
                                    </div>
                                </div>
                            </li>
                            <li class="dd-item dd3-item" data-id="1">
                                ...
                                <div class="dd3-content">
                                    <div class="checkbox">
                                        ...
                                        <label for="checkbox10">Deploy existing code to example.com</label>
                                    </div>
                                </div>
                            </li>
                            <li class="dd-item dd3-item" data-id="1">
                                ...
                                <div class="dd3-content">
                                    <div class="checkbox">
                                        ...
                                        <label for="checkbox11"><i class="zmdi zmdi-calendar m-r-5"></i> Report Panel Usag</label>
                                    </div>
                                </div>
                            </li>
                            <li class="dd-item dd3-item" data-id="1">
                                ...
                                <div class="dd3-content">
                                    <div class="checkbox">
                                        ...
                                        <label for="checkbox12"><i class="zmdi zmdi-notifications m-r-5"></i> New logo design for InfiniO</label>
                                    </div>
                                </div>
                            </li>
                        </ol>
...
<script src="{{asset('assets/js/pages/index6.js')}}"></script>
@stop